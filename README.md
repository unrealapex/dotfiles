...
That being said, suggestions are definitely open! This config will only work on Debian based distributions. The install script requires that you have `curl` installed. You can install it with `sudo apt install -y curl`.
